...
String html = "<!DOCTYPE HTML><html>"
  ...
  "body {margin:0;}"
  "p {font-size:1.0rem;}"
  ".titol {overflow:hidden;background-color:#25C098;color:white;font-size:.8rem;}"
  ".content {padding:20px;}"
  ".cards {max-width:200px;margin:0 auto;display:grid;grid-gap:2rem;grid-template-rows:repeat(auto-fit,minmax(100px,1fr));}"
